...
window.Planifolia.resolveFile=partialName=>{var basePath=window.PlanifoliaSettings.basePath,prefix=window.location.origin+window.location.pathname,result=window.Planifolia.joinPaths(prefix,basePath,partialName+".html");return window.PlanifoliaSettings.onFileResolve(result)}
